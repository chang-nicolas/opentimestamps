!(function (a, i) {
  ...
  function e(a) {
    var e = 0,
      ...
      n = 0,
      t = 1;
    for (45 === a.charCodeAt(0) && ((e = 1), (t = -1)), e; e < o.length; e++)
      n = 60 * n + i(o.charCodeAt(e));
  ...
  function u(a, i) {
    for (var e, r; (r = 6e4 * (((i.at - a.at) / 12e4) | 0)); )
      (e = new t(new Date(a.at + r))).offset === a.offset ? (a = e) : (i = e);
    return a;
  }
  function m() {
    var a,
      ...
      A = [o];
    for (e = 1; e < 48; e++)
      (i = new t(new Date(r, e, 1))).offset !== o.offset &&
        ((a = u(o, i)), A.push(a), A.push(new t(new Date(a.at + 6e4)))),
        (o = i);
    for (e = 0; e < 4; e++)
      A.push(new t(new Date(r + e, 0, 1))),
        A.push(new t(new Date(r + e, 6, 1)));
    return A;
  }
  function f(a, i) {
  ...
  function l(a, i) {
    var e, o;
    for (r(i), e = 0; e < i.length; e++)
      (o = i[e]), (D[o] = D[o] || {}), (D[o][a] = !0);
  }
  function p(a) {
    var i,
      e,
  ...
  function h(a, i) {
    ...
    return r instanceof n
      ...
      ? ((r = new n(r)), (N[a] = r), r)
      : C[a] && i !== h && (e = h(C[a], h))
      ? ((r = N[a] = new n())._set(e), (r.name = O[a]), r)
      : null;
  }
  function z(a) {
    var i, e, r, o;
  ...
  function P(i) {
    ...
    return (
      o && !a.isMoment(i) && T(A) && A.add(o.parse(A), "minutes"), A.tz(r), A
    );
  }
  function _(a) {
    return function () {
  ...
  (B < 2 || (2 === B && L < 6)) &&
      ...
      parse: function (a) {
        ...
        for (o = 0; o < t; o++)
          if (
            ...
            (e = c[o + 1]),
            (r = c[o ? o - 1 : o]),
            i < e && P.moveAmbiguousForward
              ? (i = e)
              : i > r && P.moveInvalidForward && (i = r),
            A < n[o] - 6e4 * i)
          )
            return c[o];
        return c[t];
    ...
    (P.names = function () {
      var a,
        i = [];
      for (a in O)
        O.hasOwnProperty(a) && (N[a] || N[C[a]]) && O[a] && i.push(O[a]);
      return i.sort();
    }),
    (P.Zone = n),
    (P.unpack = c),
  ...
  (a.tz = P),
    ...
    (a.updateOffset = function (i, e) {
      ...
      void 0 === i._z &&
        (o &&
          T(i) &&
          !i._isUTC &&
          ((i._d = a.utc(i._a)._d), i.utc().add(o.parse(i), "minutes")),
        (i._z = o)),
        i._z &&
          ((r = i._z.utcOffset(i)),
          Math.abs(r) < 16 && (r /= 60),
          void 0 !== i.utcOffset ? i.utcOffset(-r, e) : i.zone(r, e));
    }),
    (y.tz = function (i, e) {
      return i
        ? ((this._z = h(i)),
    ...
    (y.zoneName = _(y.zoneName)),
    (y.zoneAbbr = _(y.zoneAbbr)),
    (y.utc = (function (a) {
      return function () {
